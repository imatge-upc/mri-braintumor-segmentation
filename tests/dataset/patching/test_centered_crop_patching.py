...
def test_visual_test():
    ...
    plot_3_view("center_flair", volume[0, :, :, :], 100, save=True)
    plot_3_view("center_patch_flair", volume_patch[0, :, :, :], 100, save=True)
    plot_3_view("center_path_seg", seg_patch, 100, save=True)